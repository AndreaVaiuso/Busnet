...
public abstract class EmployeeDataWindow extends Window {
	...
	public void setHiringDateLabel(Label hiringDateLabel) {
		this.hiringDateLabel = hiringDateLabel;
	}
	...
	public void setChkLine(CheckBox chkLine) {
		this.chkLine = chkLine;
	}
	public CheckBox getChkEmployee() {
		return chkEmployee;
	}
	public void setChkEmployee(CheckBox chkEmployee) {
		this.chkEmployee = chkEmployee;
	}
	public CheckBox getChkRide() {
		return chkRide;
	}
	public void setChkRide(CheckBox chkRide) {
		this.chkRide = chkRide;
	}
	public CheckBox getChkTurn() {
		return chkTurn;
	}
	public void setChkTurn(CheckBox chkTurn) {
	...
	public void setRoleField(JTextField roleField) {
		this.roleField = roleField;
	}
	public JPanel getOkBtn() {
		return okBtn;
	}
	public void setOkBtn(JPanel okBtn) {
		this.okBtn = okBtn;
	}
	...
	public void init() {
		...
		lblLuogoDiNascita = new Label("Luogo di nascita");
		lblLuogoDiNascita.setBounds(397, 163, 173, 42);
		panel.add(lblLuogoDiNascita);
		
		placeField = new TextField();
		placeField.setColumns(10);
		placeField.setBounds(397, 205, 331, 42);
		...
		backBtn.setBounds(719, 535, 751, 54);
		panel.add(backBtn);
	...
	private void loadForms() {
		...
		getPlaceField().setText(emp.getBirthplace());

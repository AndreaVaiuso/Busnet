...
public abstract class EmployeesWindow extends Window {
	...
	public abstract void clickCalculateSalaryBtn();
	...
	private void createGUI() {
		...
		this.btnSalary = new Button("Salario") {
			@Override
			public void click() {
				clickCalculateSalaryBtn();
			}
		};
		this.btnSalary.setIcon("salary35.png");
		GridBagConstraints gbc_btnSalary = new GridBagConstraints();
		gbc_btnSalary.insets = new Insets(0, 0, 0, 0);
		gbc_btnSalary.fill = GridBagConstraints.BOTH;
		gbc_btnSalary.gridx = 4;
		gbc_btnSalary.gridy = 0;
		this.panel_1.add(this.btnSalary, gbc_btnSalary);
		...
		gbc_resetPasswordButton.gridx = 5;

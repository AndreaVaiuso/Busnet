...
public abstract class LineDataWindow extends Window {
	...
	public void init() {
		...
		this.okBtn.setBounds(404, 552, 418, 63);
		this.panel.add(this.okBtn);
		
		this.cancelBtn.setBounds(0, 552, 407, 63);
		...
		this.scrollPane.setBounds(15, 234, 790, 301);
	...
	public void setLineIdField(JTextField stopIdField) {
		this.lineIdField = stopIdField;
	}

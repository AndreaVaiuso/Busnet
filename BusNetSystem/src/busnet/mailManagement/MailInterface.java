...
public class MailInterface {
    ...
    private static boolean mailServiceIsOn = true;
    
    public static String[] days = {"Lunedì", "Martedì", "Mercoledì", "Giovedì", "Venerdì", "Sabato", "Domenica"};
    public static String[] periods = {"6-10", "9-13", "12-16", "15-19", "18-22", "21-1"};
    
    //Invio mail ad un impiegato appena aggiunto al sistema, comunicandogli  dati di accesso.
    public static void sendNewHiringMail(Employee employee, String password) throws ConnectionDownException, MessagingException, InterruptedException, ExecutionException {
        ...
        String body = employee.getSurname() + " " + employee.getName() + ", Benvenuto nel servizio BUSNET!"
        		...
        		+ "\n\nTi ricordiamo che, per garantire la tua sicurezza, il sevizio BUSNET ti permette di scegliere la tua password personale"
    ...
    public static void sendResetPasswordMail(Employee employee, String password) throws ConnectionDownException, MessagingException, InterruptedException, ExecutionException{
    ...
    private static void sendFromGMail(String from, String pass, String[] to, String subject, String body) throws ConnectionDownException, MessagingException, InterruptedException, ExecutionException{
		if(mailServiceIsOn) {
    ...
    public static void sendDefaultScheduleModifiedMail(ShiftDefaultList sdList, Employee employee) throws ConnectionDownException, MessagingException, InterruptedException, ExecutionException{
    ...
    public static void sendTempScheduleRemovedMail(ShiftTemporaryList stList, Employee employee) throws ConnectionDownException, MessagingException, InterruptedException, ExecutionException{
    ...
    public static void sendTempScheduleModifiedMail(ShiftTemporaryList stList, Employee employee) throws ConnectionDownException, MessagingException, InterruptedException, ExecutionException{
